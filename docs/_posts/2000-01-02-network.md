...
It is interesting to see how Luke Skywalker has the 5th highest in-degree, but only the 13th highest out-degree. This fits quite well into the story where he isolates himself. R2D2 is a case of almost the opposite, which also fits with the story since he can't speak and is kind of a sidekick character, although he has a lot of screen-time.